...
- M1-03 已完成（盲注通關/失敗與商店後推進流程）。
- M1-04 已完成（商店 offer 生成與購買流程）。
- M2-01 已完成（Lv0~Lv4 行為模型 + Boss Lv4 特例）。
- M2-02 已完成（答錯三選一決策與成本規則）。
- M2-03 已完成（退化規則 1/3/7 天 + DecayManagerV2）。
- M2-04 已完成（Boss +1 階 / 連對 x2 / 全對升級）。
- M2 全部完成，目前主軸：M3-01（XP/LP 結算）。
