...
| TC-S8-004 | S8 誤報防護 | 高通關但主動回憶偏低時，不觸發 `GATE_TOO_EASY` |
| TC-S8-005 | S8 漏報補抓 | 邊界通關率且長時間卡關時，觸發 `GATE_TOO_HARD` |
...
| TC-S10-001 | S10-M1 核心菜單繁中 | 主 UI 核心按鈕為繁中，且無舊英文菜單字樣 |
| TC-S10-002 | S10-M2 狀態與局外資訊繁中 | 狀態欄與局外資訊使用繁中詞彙（關卡/經驗/學習點） |
| TC-S10-003 | S10-M3 學習區英文例外 | 手牌/題幹可保留英文詞彙字幹 |
| TC-S10-004 | S10-M4 共用字串映射繁中 | `PrototypeUiText` 關鍵映射皆為繁中且不含舊英文詞 |
| TC-S10-005 | S10-M5 舊版控制器停用 | 新版 UI 啟動後會自動停用舊版 Prototype 控制器 |
| TC-S10-006 | S10-M7 正式版核心區塊保留 | 玩家模式仍保留牌桌/答題/商店與核心操作按鈕 |
