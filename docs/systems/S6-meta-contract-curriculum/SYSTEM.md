...
- 本輪設計問題：
1. 雖已完成 Batch-3，仍有部分節點效果未入場（例：FLU_04/05/07/09/12、LEX_04/05/06A/06B/07/08/12、BLD_01/02/03A/03B/06A/06B/07/10A/10B/11/12、MAS_04/05/07/09/10A/11/12 的完整運行掛載）。
- 調整建議：
1. 進入 S6-Effect 第四批：優先補 FLU（保底/全對/連對維持）與 BLD（重擲與商店候選控制）高體感節點。
